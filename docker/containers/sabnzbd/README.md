...
2. Run the following through the Komodo terminal
   ...
   mkdir /media/downloads/sabnzbd/incomplete && \
   cd /media/downloads/sabnzbd/complete && \
   mkdir movies_en && \
   mkdir movies_anime && \
   mkdir movies_de && \
   mkdir series_en && \
...
3. Run this command on the Docker host
     - Import the scripts from the [TRaSH Guides](https://trash-guides.info/Downloaders/SABnzbd/scripts/)
       ...
       wget https://raw.githubusercontent.com/platnub/container-host-templates/refs/heads/main/docker/containers/sabnzbd/scripts/Clean.py && \
       wget https://raw.githubusercontent.com/platnub/container-host-templates/refs/heads/main/docker/containers/sabnzbd/scripts/replace_for.py && \
       chmod +x Clean.py && \
       chmod +x replace_for.py && \
       chown 1000:1000 Clean.py && \
       chown 1000:1000 replace_for.py
       ```
